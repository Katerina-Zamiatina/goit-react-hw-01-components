...
// обратного вызова(callback).Функция mapArray создает
// новый массив numbers и заполняет его числами из массива
...
// const subIndex = (element, index) => { return element - index; };
...
// array - массив чисел, а вторым параметром cb -
...
//     const element = array[i];
//     const index = i;
//     const ifTrue = cb(element, index, arr);
//     if (ifTrue) {
...
// разность или произведение всех элементов массива в зависимости от
// того какая именно из трех функция(add, mult, sub) будет передана
// в качестве cb.
...
// чтобы в качестве this для методов inventory.add
